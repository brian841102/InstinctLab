...
class CommandsCfg:
    ...
    base_velocity = mdp.PoseVelocityCommandCfg(
        ...
        velocity_ranges={
            "perlin_rough": {"lin_vel_x": (0.2, 1.0), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            ...
            "pyramid_stairs": {"lin_vel_x": (0.2, 0.8), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_high": {"lin_vel_x": (0.45, 0.8), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_inv": {"lin_vel_x": (0.2, 0.8), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
